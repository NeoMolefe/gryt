...
const ARCHETYPE_TEMPLATES: Record<Archetype, SessionTemplate[]> = {
  ...
  'Endurance Athlete': [
    ...
    { session_name: 'Strength Session', focus: ['lower', 'upper_push', 'upper_pull', 'core'] },
    ...
    { session_name: 'Strength Session II', focus: ['lower', 'upper_push', 'upper_pull', 'core'] },
    { session_name: 'Tempo Run II', focus: ['conditioning', 'vo2max'], conditioning_type_constraint: ['steady_state'] },
  ],
  'Hybrid Performer': [
    { session_name: 'Strength Session', focus: ['lower', 'upper_push', 'upper_pull'] },
    ...
    { session_name: 'Conditioning Session II', focus: ['conditioning', 'vo2max', 'core'] },
